...
def analyze():
    ...
    md.append("- **Phonetic Distance**: Computed via `epitran` G2P transliteration and Levenshtein phoneme error rate.\n")
    md.append("- **Audio Files**: Raw audio clips persisted to `results/clips/` for auditory inspection.\n")
